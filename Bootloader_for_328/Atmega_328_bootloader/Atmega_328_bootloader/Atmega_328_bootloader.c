...
#include "328_Bootloader_header.h"
#define Version "Atmega 328 (UNO) bootloader_V1 "
...
prog_led_control = 0;  record_length_old=0; prog_counter = 0;		//Initialize variables
...
start_new_code_block(); 											//Initialize new programming block (usually starts at address zero but not exclusivle so)
